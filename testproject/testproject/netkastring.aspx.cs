...
{
    public partial class netkastring : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            String Hour_to_Resolve;
            String Hour_to_Resolve_Pending;
            String Closed_Time;
            String Hour_to_Closed;
            String Hour_to_Closed_Pending;
            String Root_Cause;
            String Resolved_Method;
            String New_to_response;
            String New_to_Assign;
            String Latest_Resolve_to_Close;
            String Latest_Response_to_Close;
            String Agent_UTL_Time;
            String Eng_UTL_Time;
            ...
            while (dr.Read())
            {
                ...
                Hour_to_Resolve = dr[33].ToString();
                Hour_to_Resolve_Pending = dr[34].ToString();
                Closed_Time = dr[35].ToString();
                Hour_to_Closed = dr[36].ToString();
                Hour_to_Closed_Pending = dr[37].ToString();
                Root_Cause = dr[38].ToString();
                Resolved_Method = dr[39].ToString();
                New_to_response = dr[40].ToString();
                New_to_Assign = dr[41].ToString();
                Latest_Resolve_to_Close = dr[42].ToString();
                Latest_Response_to_Close = dr[43].ToString();
                Agent_UTL_Time = dr[44].ToString();
                Eng_UTL_Time = dr[45].ToString();
        ...
        private void savedata(float ID1, String Case_ID1, String Created_Date1, String Created_By1, String Title1, String Case_Status1, String Case_Type1, String Service_Type1, String Case_Category1, String Case_Sub_Category1, String Engineer1, String Team1
                    ...
                    , String Onsite_Duration1, String Resolve_Duration1, String Close_Duration1, String Case_Duration1, String Response1, String Onsite1, String Resolve1, String Auto_Close1, String SLA1, String Resolved_Time1, String Hour_to_Resolve1
                    , String Hour_to_Resolve_Pending1, String Closed_Time1, String Hour_to_Closed1, String Hour_to_Closed_Pending1, String Root_Cause1, String Resolved_Method1, String New_to_response1, String New_to_Assign1
                    , String Latest_Resolve_to_Close1, String Latest_Response_to_Close1, String Agent_UTL_Time1, String Eng_UTL_Time1)
        {
